...
export default function Footer() {
  ...
  const amenities =[
    "Secured Campus","Comprehensive Library","STEM & Robotics Labs","Smart Parent Portal","Eco Park and Butterfly Garden","Coding and Game Design Studio","Creative and Cultural Spaces"
  ]
  return (
        ...
        <div className="border-b-2 pb-4 border-secondary">
          ...
          <div className="mt-6 ">
            ...
            <div className="mt-4">
              ...
              <div className="mt-2">
                <a href="mailto:info@wesparkschool.in">info@wesparkschool.in</a>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="mt-3 text-gray-300/80">
            <ul className="grid gap-2">
              ...
              <li>
              <a href="https://forms.gle/2iZ2fDAm4YCtkWQv7" target="_blank" className="hover:text-white">
                  Admission
                </a>
              </li>
              <li>
 ...
 <p className="text-gray-400 text-sm">Copyright All Right Reserved 2025</p>
